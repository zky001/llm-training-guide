...
| 第 2 章 · 神经网络与训练三件套 | 损失、梯度下降、反向传播 | 🚧 |
| 第 3 章 · Transformer 架构 | 注意力、QKV、采样生成 | 🚧 |
| 第 4 章 · 预训练 | 数据工程、Scaling Laws、并行训练 | 🚧 |
| 第 5 章 · 后训练与对齐 | SFT、RLHF、DPO/GRPO | 🚧 |
| 第 6 章 · 推理与部署 | KV Cache、量化、蒸馏 | 🚧 |
| 第 7 章 · 评测 | Benchmark、数据污染、LLM 裁判 | 🚧 |
| 第 8 章 · 前沿与全景 | MoE、长上下文、多模态、推理模型 | 🚧 |
| 附录 | 术语表、动手实践路线、论文清单 | ✅ |

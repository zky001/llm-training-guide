---
title: 附录 · 实战路线
description: 100 行搭一个不依赖框架的 RAG、向量库与框架地图、避坑清单，以及中篇结语。
---
...
:::tip 选型心法
和下篇的框架建议一样：**先用上面那 100 行把原理跑通**，再带着「我到底需要工具替我做哪些活」去选——而不是被某个框架的抽象牵着理解 RAG。所有框架的内核，都是你已经读懂的「检索→增强→生成」。（本表整理于 2026 年，生态演进快，以官方文档为准。）
:::
